package jsoft.map.symbol
{
	...
	public class ImagePointSymbol extends Symbol
	{
		private var imgUrl:String = "";
		private var imgWidth:int = 5;
		private	var imgHeight:int = 0;
		
		public function ImagePointSymbol() {
		}
		...
		public override function copyTo(symbol:Symbol):void {
			super.copyTo(symbol);
			var point:ImagePointSymbol = symbol as ImagePointSymbol;
			point.imgUrl = imgUrl;
