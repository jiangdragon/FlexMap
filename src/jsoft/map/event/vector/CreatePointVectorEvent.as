package jsoft.map.event.vector
{
	...
	public class CreatePointVectorEvent implements MapEvent
	{
		...
		public function CreatePointVectorEvent(vector:IVector) {
		...
		public function onMouseDown(event:MouseEvent):Boolean {
			...
			drawVector(endX,endY,endX,endY);
			return true;
		}
		...
		public function onMouseUp(event:MouseEvent):Boolean {
			if(mouseDown) {
				...
				var minx:Number = coord.mapFromViewX(endX);
				var miny:Number = coord.mapFromViewY(endY);
