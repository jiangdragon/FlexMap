package jsoft.map.event.vector
{
	...
	public class CreateArrowVector implements MapEvent
	{
		...
		public function CreateArrowVector(vector:IVector) {
...
//				trace("offsetX="+offsetX+", offsetY="+offsetY);
		...
		private function drawArrow(endX:Number,endY:Number,offsetX:Number,offsetY:Number) : void {
			...
			mx += offsetX;
			my += offsetY;
			var arr1:ArrowHelper = arrow.createHelper();
			arr1.addPointEx(mx,my,endX,endY);
			arr1.draw();
		}
