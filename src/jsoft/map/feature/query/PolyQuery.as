package jsoft.map.feature.query
{
	...
	public class PolyQuery implements FeatureCallBack
	{
		...
		public function query(source:String,layerName:String,xAry:String,yAry:String,around:Number,_where:String,queryFlag:int,maxPageRecord:int):void {
			...
			featureServer.addStrParam("xAry",xAry);
			featureServer.addStrParam("yAry",yAry);
			...
			featureServer.processMapEvent("polyQuery");
		}
