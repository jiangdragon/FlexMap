package jsoft.map.vector.poly
{
	...
	public class OvalVector extends BaseVector implements IVector
	{
		...
		public override function clone():IVector {
			var newVector:OvalVector = new OvalVector();
			copyTo(newVector);
		...
		private function drawSinglePolygon(geometry:Geometry,coordinate:Coordinate,pointCount:int):int {
			...
			drawUtil.drawOval(x_arr[0],y_arr[0],w,h);
			return pointCount;
		}
