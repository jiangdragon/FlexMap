package jsoft.map.vector.poly
{
	...
	public class RectVector extends BaseVector implements IVector
	{
		...
		public override function clone():IVector {
			var newVector:RectVector = new RectVector();
			copyTo(newVector);
		...
		private function drawSinglePolygon(geometry:Geometry,coordinate:Coordinate,pointCount:int):int {
			...
			drawUtil.drawRect(x_arr[0],y_arr[0],x_arr[2],y_arr[2]);
			return pointCount;
		}
