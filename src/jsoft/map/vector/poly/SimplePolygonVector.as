package jsoft.map.vector.poly
{
	...
	public class SimplePolygonVector extends BaseVector implements IVector
	{
		...
		public function SimplePolygonVector() {
			super();
		}
		
		public override function getVectorName():String {
			return "SimplePolygonVector";
		}
		...
		public override function clone():IVector {
			var newVector:SimplePolygonVector = new SimplePolygonVector();
			copyTo(newVector);
